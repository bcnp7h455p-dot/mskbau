(function(){
  function renderLofts(){
    ...
    var lofts = [
      {name:'Cactus',area:'140 Ð¼Â²',cap:'80 ÑÑÑÑÐµÑ / 50 Ð±Ð°Ð½ÐºÐµÑ / 70 ÑÐµÐ°ÑÑ',metro:'ÐÐ°ÑÐ¼Ð°Ð½ÑÐºÐ°Ñ',desc:'ÐÐ²ÑÑÑÑÐ¾Ð²Ð½ÐµÐ²ÑÐ¹ Ð»Ð¾ÑÑ Ð² Ð°ÑÑ-Ð¿ÑÐ¾ÑÑÑÐ°Ð½ÑÑÐ²Ðµ ÐÐ°ÑÐ¼Ð°Ð½Ð½ÑÐ¹ Ð´Ð²Ð¾Ñ. ÐÐ¾Ð»ÑÑÐ¸Ðµ Ð»ÑÑÑÑÑ Ð¿ÑÐ¸ÑÑÐ³Ð¸Ð²Ð°ÑÑ Ð²Ð·Ð³Ð»ÑÐ´Ñ. Ð£Ð´Ð¾Ð±Ð½Ð°Ñ Ð±Ð°ÑÐ½Ð°Ñ Ð·Ð¾Ð½Ð° Ñ ÐºÑÑÐ½ÐµÐ¹ Ð½Ð° Ð¿ÐµÑÐ²Ð¾Ð¼ ÑÑÐ°Ð¶Ðµ. ÐÐ° Ð²ÑÐ¾ÑÐ¾Ð¼ â Ð»Ð°ÑÐ½Ð´Ð¶-Ð·Ð¾Ð½Ð° Ñ Ð´Ð¸Ð²Ð°Ð½Ð°Ð¼Ð¸ Ð¸ ÐºÑÐµÑÐ»Ð°Ð¼Ð¸. ÐÐ°ÑÑÐ¾Ð»ÑÐ½ÑÐ¹ ÑÑÑÐ±Ð¾Ð» Ð¸ Ð¸Ð³ÑÐ¾Ð²Ð°Ñ Ð¿ÑÐ¸ÑÑÐ°Ð²ÐºÐ° Ñ ÑÐµÑÑÐ¾-Ð¸Ð³ÑÐ°Ð¼Ð¸.',img:'https://static.tildacdn.com/tild6339-3261-4166-a131-306239343833/IMG_5653_resized.jpg',price:'Ð¾Ñ 2 400 â½/ÑÐ°Ñ'},
    ...
    grid.innerHTML = lofts.map(function(l){
      return '<div class="loft-card">'
        +'<img class="lc-img" src="'+l.img+'" alt="ÐÐ¾ÑÑ '+l.name+'" loading="lazy" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;transition:transform 0.8s ease"/>'
        +'<div class="lc-ov"></div>'
        +'<div class="lc-body">'
